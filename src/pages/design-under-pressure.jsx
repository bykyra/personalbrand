        ...
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-9">
            <h1 className="text-base font-medium text-gray-900 mb-4 leading-snug">
              From Handwritten Notes to a Live Stage 
            </h1>
        ...
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-9 space-y-6">
            <p className="text-sm text-gray-700 leading-relaxed text-justify">
              Every Tuesday night, I receive a set of handwritten notes. By Wednesday lunchtime, 
            ...
            <p className="text-sm text-gray-700 leading-relaxed text-justify">
              ...
              extra layer of approval, just something that works, reliably.
            </p>
          </div>
        </div>
      </article>
